...
public class SkillSlotUI : MonoBehaviour
{
    ...
    // 运行时数据
    public SkillBarUI.SkillSlotConfig Config { get; private set; }
    ...
    /// 初始化技能槽
    /// </summary>
    public void Initialize(SkillBarUI.SkillSlotConfig config, SkillBarUI manager)
    {
        Config = config;
        _manager = manager;
        ...
        if (nameText != null)
        {
            nameText.text = config.skillData.name;
        }
